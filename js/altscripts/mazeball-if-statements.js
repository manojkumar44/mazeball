...
var topBoundary = 0;
var leftBoundary = 0;
var rightBoundary = 1205;
var bottomBoundary = 725;
var changePos = 75;
...
//		marble.style.left = parseInt(marble.style.left) = leftBoundary + "px";
//	}	else {
...
//		marble.style.top = parseInt(marble.style.top) = topBoundary + "px";
//	}	else {
...
//		marble.style.left = parseInt(marble.style.left) = rightBoundary + "px";
//	}	else {
	marble.style.left = parseInt(marble.style.left) + changePos + "px";
//	}
	break;
...
//		marble.style.top = parseInt(marble.style.top) = bottomBoundary + "px";
//	}	else {
		marble.style.top = parseInt(marble.style.top) + changePos + "px"
//	}
	break;
